#
#  Be sure to run `pod spec lint armadillo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Alexander List" => "atlex2@gmail.com" }
  # Or just: s.author    = "Alexander List"
  # s.authors            = { "Alexander List" => "atlex2@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Alexander List"
